...
DESCRIPTION
   ...
   chromosome, position, ref_base, depth, read_start_count|read_end_count|start_and_end_count, mutations, mutation fractions, support reads, chain fractions, support reads for each chain
...
def parse_info(info_string, ref, depth):
    ...
    info = start_end_info+'\t'+name + '\t' + freq + '\t' + support + '\t' + chainF + '\t' + chainS + '\n'
    return info
